# FinanzGecko — Repo Instructions (for Gemini CLI)
...
mirrors its visual-identity tokens for a design/marketing audience; [gherkin/](gherkin/) holds the behavioral spec.
Read all three before making any non-trivial change. [CLAUDE.md](CLAUDE.md) carries the full day-to-day working
instructions (navigation shortcuts, regeneration recipes, website traps) — despite the name it isn't
