...
void main() {
  ...
  testWidgets('Enter in the "Neues Konto" form submits it, same as clicking "Konto anlegen"', (tester) async {
    ...
    await tester.enterText(byLabel('Bank'), 'DKB');
    await tester.pumpAndSettle();
    await tester.enterText(byLabel('Name'), 'Gehaltskonto');
    await tester.testTextInput.receiveAction(TextInputAction.done);
    await tester.pumpAndSettle();

    expect(store.getAccounts().map((a) => a.name), contains('Gehaltskonto'));
  });
}
