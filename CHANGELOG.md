...
- 📝 Revamp docs with screenshots and OG metadata (97acb4b)
- ✈️ Add diagnostics help section in settings (f28e8b3)
- ✏️ Clarify platform-specific update workflow (5c5c907)
- 📝 Changelog für v1.2.1 (e6da36c)


## v1.2.1 - 2026-07-19

- 🔖 Version 1.2.1+5 (6d8a07c)
- 🐛 Limit Windows installer to German (3797580)
- 📝 Changelog für v1.2.0 (ef69319)


## v1.2.0 - 2026-07-19

- 🔖 Version 1.2.0+4 (928bdf1)
- 👷 Pakete statt rohe Bundles als Release-Artefakte (5620039)
- ✅ Add v1 backup fixture for compatibility tests (6922c6c)
- 🔒️ Guard schema versions during startup load (6808fdd)
