...
For the full architecture/data-flow/domain reference see the AI reference set in [ai/](ai/). This file only covers
...
Neither setting should be reverted without discussion first (see [ai/rules.md](ai/rules.md)).
